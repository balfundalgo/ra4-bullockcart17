...
class BullockCartApp(ctk.CTk):
    ...
    def _build_settings(self):
        ...
        self.btn_save = ctk.CTkButton(p, text="💾  SAVE PARAMETERS", font=FM,
                                       fg_color=ACC, hover_color="#025a8c",
                                       text_color="white", height=46, corner_radius=8,
    ...
    def _handle(self, ev, d):
        if ev == "status":
            ...
            if changes:
                ...
                self._log("  No parameter changes detected")
    ...
    def _on_start(self):
        ...
        def _run():
            try:
                ...
                cfg = getattr(self, '_saved_config', None) or self._build_config()
    ...
    def _on_save(self):
        """Read current GUI values and push to running engine, or store for next start."""
